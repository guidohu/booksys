...
func registerHandlers(mux *http.ServeMux, h *handlers.Handler) {
	...
	mux.Handle("/api/v2/session/delete", h.WithAdminAuthentication(h.DeleteSession))
	mux.Handle("/api/v2/session/edit", h.WithAdminAuthentication(h.EditSession))
	mux.Handle("/api/v2/session/heats/get", h.WithAdminAuthentication(h.GetSessionHeats))
	mux.Handle("/api/v2/session/metadata/get", h.WithAdminAuthentication(h.GetSessionMetadata))
	mux.Handle("/api/v2/session/user/add", h.WithAdminAuthentication(h.AddUserToSession))
	mux.Handle("/api/v2/session/user/remove", h.WithAdminAuthentication(h.RemoveUserFromSession))

	mux.Handle("/api/v2/mynautique/credentials/setup", h.WithAdminAuthentication(h.SetupMyNautiqueCredentials))

	mux.Handle("/api/v2/user/delete", h.WithAdminAuthentication(h.DeleteUser))
	...
	mux.Handle("/api/v2/user/lock/set", h.WithAdminAuthentication(h.SetUserLock))
	mux.Handle("/api/v2/user/group/create", h.WithAdminAuthentication(h.CreateUserGroup))
	mux.Handle("/api/v2/user/group/edit", h.WithAdminAuthentication(h.ChangeUserGroup))
	mux.Handle("/api/v2/user/group/delete", h.WithAdminAuthentication(h.DeleteUserGroup))
	mux.Handle("/api/v2/user/group/set", h.WithAdminAuthentication(h.SetUserGroup))
	...
	mux.Handle("/api/v2/admin/configuration/set", h.WithAdminAuthentication(h.SetConfiguration))
