...
func main() {
	...
	http.Handle("/api/v2/session/heats/get", http.HandlerFunc(h.WithAuthentication(h.GetSessionHeats)))
	http.Handle("/api/v2/session/metadata/get", http.HandlerFunc(h.WithAuthentication(h.GetSessionMetadata)))
	...
	http.Handle("/api/v2/user/lock/set", http.HandlerFunc(h.WithAuthentication(h.SetUserLock)))
	...
	http.Handle("/api/v2/user/group/delete", http.HandlerFunc(h.WithAuthentication(h.DeleteUserGroup)))
	http.Handle("/api/v2/user/group/set", http.HandlerFunc(h.WithAuthentication(h.SetUserGroup)))
	http.Handle("/api/v2/user/groups/get", http.HandlerFunc(h.WithAuthentication(h.GetUserGroups)))
